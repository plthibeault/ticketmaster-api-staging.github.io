(function(B, n) {
    ...
    function B(a) {
        if (null === r) {
            for (var g = a.length, c = 0, k = document.getElementById(C), f = "<ul>"; c < g;) f += "<li>" + a[c] + "</li>", c++;
            k.innerHTML = f + "</ul>"
        } else r(a)
    }
    ...
    function E(a) {
        if (void 0 !== a) return a = a.innerHTML.match(/data-srcset="([A-z0-9%_\.-]+)/i)[0], decodeURIComponent(a).split('"')[1]
    }
    var C = "",
        g = 20,
        F = !0,
        ...
        L = {
            fetch: function(a) {
                void 0 === a.maxTweets && (a.maxTweets =
                    20);
            ...
            callback: function(a) {
                ...
                if (A)
                    for (c = c.getElementsByClassName("tweet"); e < c.length;) {
                        ...
                        if (!b[e] || b[e] && G) a.push(c[e].getElementsByClassName("e-entry-title")[0]),
                            p.push(c[e].getAttribute("data-tweet-id")), k.push(m(c[e].getElementsByClassName("p-author")[0])), f.push(c[e].getElementsByClassName("dt-updated")[0]), q.push(c[e].getElementsByClassName("permalink")[0]), void 0 !== c[e].getElementsByClassName("inline-media")[0] ? h.push(c[e].getElementsByClassName("inline-media")[0]) : h.push(void 0);
                        e++
                    } else
                    for (c = l(c, "tweet"); e < c.length;) a.push(l(c[e], "e-entry-title")[0]), p.push(c[e].getAttribute("data-tweet-id")), k.push(m(l(c[e], "p-author")[0])), f.push(l(c[e], "dt-updated")[0]),
                        q.push(l(c[e], "permalink")[0]), void 0 !== l(c[e], "inline-media")[0] ? h.push(l(c[e], "inline-media")[0]) : h.push(void 0), 0 < l(c[e], "retweet-credit").length ? b.push(!0) : b.push(!1), e++;
                a.length > g && (a.splice(g, a.length - g), k.splice(g, k.length - g), f.splice(g, f.length - g), b.splice(g, b.length - g), h.splice(g, h.length - g), q.splice(g, q.length - g));
                var c = [],
                    e = a.length,
                    d = 0;
                if (K)
                    ...
                    for (; d <
                        ...
                        if ("string" !== typeof z) {
                            var b = f[d].getAttribute("datetime"),
                                v = new Date(f[d].getAttribute("datetime").replace(/-/g, "/").replace("T", " ").split("+")[0]),
                                b = z(v, b);
                            f[d].setAttribute("aria-label", b);
                            if (a[d].innerText)
                                if (A) f[d].innerText = b;
                                else {
                        ...
                        b = "";
                        F ? (u && (D(a[d]), t && D(k[d])), t && (b += '<div class="user">' + n(k[d].innerHTML) + "</div>"), b += '<p class="tweet">' + n(a[d].innerHTML) +
                            "</p>", x && (b = J ? b + ('<p class="timePosted"><a href="' + q[d] + '">' + f[d].getAttribute("aria-label") + "</a></p>") : b + ('<p class="timePosted">' + f[d].getAttribute("aria-label") + "</p>"))) : a[d].innerText ? (t && (b += '<p class="user">' + k[d].innerText + "</p>"), b += '<p class="tweet">' + a[d].innerText + "</p>", x && (b += '<p class="timePosted">' + f[d].innerText + "</p>")) : (t && (b += '<p class="user">' + k[d].textContent + "</p>"), b += '<p class="tweet">' + a[d].textContent + "</p>", x && (b += '<p class="timePosted">' + f[d].textContent + "</p>"));
                        H &&
                        (b += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + p[d] + '" class="twitter_reply_icon"' + (u ? ' target="_blank">' : ">") + 'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' + p[d] + '" class="twitter_retweet_icon"' + (u ? ' target="_blank">' : ">") + 'Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id=' + p[d] + '" class="twitter_fav_icon"' + (u ? ' target="_blank">' : ">") + "Favorite</a></p>");
                        I && void 0 !== h[d] && (b += '<div class="media"><img src="' + E(h[d]) + '" alt="Image from tweet" /></div>');
                        c.push(b);
                        d++
                    }
                B(c);
                y = !1;
                0 < w.length && (L.fetch(w[0]), w.splice(0, 1))
            }
        };
